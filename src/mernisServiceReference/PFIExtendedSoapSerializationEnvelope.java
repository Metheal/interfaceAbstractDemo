...
public class PFIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PFIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PFIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PFIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PFIDateTimeConverter dateTimeConverter = new PFIStandardDateTimeConverter();

    public PFIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PFIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PFIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PFIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PFIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PFIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
