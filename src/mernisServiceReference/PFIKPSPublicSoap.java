...
public class PFIKPSPublicSoap
{
    ...
    public PFIKPSPublicSoap(){}

    public PFIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PFIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PFIExtendedSoapSerializationEnvelope envelope= new PFIExtendedSoapSerializationEnvelope(PFIExtendedSoapSerializationEnvelope.VER11);
